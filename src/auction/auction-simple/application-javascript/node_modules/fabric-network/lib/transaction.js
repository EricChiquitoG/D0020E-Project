...
class Transaction {
    ...
    async submit(...args) {
        if (args[2]==false) {
            const msg = `Bid submitted after auction end`;
            throw new Error(msg);
        } else if (args[3]==false) {
            const msg = `Bid is not higher than current highest bid`;
            throw new Error(msg);
        }
    ...
    async evaluate(...args) {
        ...
        // Added logic for transaction validation
