...
function createOrgs() {
  ...
  infoln "Generating CCP files for NULL"
  ./organizations/ccp-generate.sh 4 7054 8054 10054 11054 7051 9051 11051 13051
}
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} run --rm -v /home/ericadmin/Go/src/github.com/EricChiquitoG/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/org1/msp organizations/fabric-ca/org1/tls-cert.pem organizations/fabric-ca//ca-cert.pem organizations/fabric-ca/org1/IssuerPublicKey organizations/fabric-ca/1/IssuerRevocationPublicKey organizations/fabric-ca/org1/fabric-ca-server.db

    ${CONTAINER_CLI} run --rm -v /home/ericadmin/Go/src/github.com/EricChiquitoG/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/org2/msp organizations/fabric-ca/org2/tls-cert.pem organizations/fabric-ca//ca-cert.pem organizations/fabric-ca/org2/IssuerPublicKey organizations/fabric-ca/2/IssuerRevocationPublicKey organizations/fabric-ca/org2/fabric-ca-server.db

    ${CONTAINER_CLI} run --rm -v /home/ericadmin/Go/src/github.com/EricChiquitoG/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/org3/msp organizations/fabric-ca/org3/tls-cert.pem organizations/fabric-ca//ca-cert.pem organizations/fabric-ca/org3/IssuerPublicKey organizations/fabric-ca/3/IssuerRevocationPublicKey organizations/fabric-ca/org3/fabric-ca-server.db

    ${CONTAINER_CLI} run --rm -v /home/ericadmin/Go/src/github.com/EricChiquitoG/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/org4/msp organizations/fabric-ca/org4/tls-cert.pem organizations/fabric-ca//ca-cert.pem organizations/fabric-ca/org4/IssuerPublicKey organizations/fabric-ca/4/IssuerRevocationPublicKey organizations/fabric-ca/org4/fabric-ca-server.db
    #repeatX##removeOrg#


    ###REMOVE-ORDERER
    ${CONTAINER_CLI} run --rm -v /home/ericadmin/Go/src/github.com/EricChiquitoG/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/ordererOrg/msp organizations/fabric-ca/ordererOrg/tls-cert.pem organizations/fabric-ca/ordererOrg/ca-cert.pem organizations/fabric-ca/ordererOrg/IssuerPublicKey organizations/fabric-ca/ordererOrg/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg/fabric-ca-server.db
    ###
